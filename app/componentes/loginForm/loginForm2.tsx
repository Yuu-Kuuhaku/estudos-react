...
export default function LoginForm2({appearance= 'normal'}:LoginFormProps) {
    ...
    <>
      <div className="max-w-[300px] my-2 w-full m-auto p-[20px] bg-white text-black border-solid border border-black rounded-sm">
        <form action={handleSubmit}>
          <h2 className="mb-2 text-lg uppercase font-bold text-center">Login com outra versão de Input </h2>
